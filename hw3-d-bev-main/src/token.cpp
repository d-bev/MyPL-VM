...
// AUTH: S. Bowers
// DESC: Token class implementation
//----------------------------------------------------------------------
...
{
  // map token type's to printable string
  std::unordered_map<TokenType,std::string> ts = {
    ...
    {TokenType::FOR, "FOR"},
    {TokenType::WHILE, "WHILE"}, {TokenType::IF, "IF"},
    {TokenType::ELSEIF, "ELSEIF"}, {TokenType::ELSE, "ELSE"},
    {TokenType::AND, "AND"}, {TokenType::OR, "OR"},
    {TokenType::NOT, "NOT"}, {TokenType::NEW, "NEW"},
    {TokenType::RETURN, "RETURN"}
  };
  // return string representation of a token (for printing)
